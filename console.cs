...
exec("observer.cs");
exec("Players.cs");
exec("SelectPlayers.cs");

// Used for if you're executing with +connect tribes.pcrpg.org:28001
if($AUTOSELECTPLAYER::Name == "Caboose") {
	echo("");
	echo("=========================");
	echo(">>> AUTOSELECTING CABOOSE");
	echo("=========================");
	echo("");
	$PCFG::CurrentPlayer = "0";
	$PCFG::Name = "Caboose";
	$PCFG::Info = "CABOOSE_PASSWORD_HERE";
	$AUTOSELECTPLAYER::Name = "SIayer";
	// exec("autoremort.cs");
}
else if($AUTOSELECTPLAYER::Name == "SIayer") {
	echo("");
	echo("========================");
	echo(">>> AUTOSELECTING SIAYER");
	echo("========================");
	echo("");
	$PCFG::CurrentPlayer = "2";
	$PCFG::Name = "SIayer";
	$PCFG::Info = "SIAYER_PASSWORD_HERE";
	$AUTOSELECTPLAYER::Name = "Caboose";
	// exec("SiayerMining.cs");
}
else {
	echo("");
	echo("=========================");
...
else
{
   ...
   else if($connectAddress != "")
   {
	...
	//   $PCFG::Name = "SIayer";
	//   $PCFG::Info = "SIAYER_PASSWORD_HERE";
	// +connect tribes.pcrpg.org:28001
	// +connect 12.234.150.214:28001
